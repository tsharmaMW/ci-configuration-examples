KgToPounds MATLAB Python Package
...
2. Installing the KgToPounds Package

A. Change to the directory that contains the file setup.py and the subdirectory 
KgToPounds. If you do not have write permissions, copy all its contents to a temporary 
...
3. Using the KgToPounds Package

The KgToPounds package is on your Python path. To import it into a Python script or 
session, execute:
